...
// Instrucciones
    ...
    void cpu::I_cpy() {
        ...
        // asignacion de flags
        ASSIGN_BIT(status, CARRY_BIT, ry >= valor);
        ASSIGN_BIT(status, CERO_BIT, ry == valor);
        ASSIGN_BIT(status, NEGATIVE_BIT, cmp & 0x80);
